...
//    @NamedQuery(name = "SubscriberDetails.SrvCOUNT", query = "select s from  SubscriberDetails where s.subdSrvCode = :subdSrvCode)"),
//    @NamedQuery(name = "SubscriberDetails.SsrvCOUNT", query = "select s from  SubscriberDetails where s.subdSsrvCode =:subdSsrvCode)"),
//    @NamedQuery(name = "SubscriberDetails.SrvCOUNT", query = "SELECT   COUNT(s) FROM SubscriberDetails  WHERE s.subdSrvCode= :subdSrvCode "),
//    @NamedQuery(name = "SubscriberDetails.SsrvCOUNT", query = "SELECT   COUNT(s) FROM SubscriberDetails  WHERE s.subdSsrvCode= :subdSsrvCode AND s.subdSrvCode= :subdSrvCode"),
//    @NamedQuery(name = "SubscriberDetails.SsrvCOUNT", query = "SELECT   COUNT(*) FROM SubscriberDetails  WHERE subdSrvCode IN (:subdSrvCode) AND subdSsrvCode IN (:subdSsrvCode) "),
