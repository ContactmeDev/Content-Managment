...
@NamedQueries({
    ...
    @NamedQuery(name = "SubserviceMast.findBySsrvSrvCode", query = "SELECT s FROM SubserviceMast s WHERE s.ssrvSrvCode = :ssrvSrvCode"),
...
//    @Column(name = "SSRV_SRV_CODE")
//    private String ssrvSrvCode;
    @Size(max = 1)
    ...
    @Size(max = 1000)
    @Column(name = "SSRV_DESC")
    private String ssrvDesc;
    @Size(max = 1000)
    @Column(name = "SSRV_DESC_AR")
...
//    public String getSsrvSrvCode() {
//        return ssrvSrvCode;
//    }
//
//    public void setSsrvSrvCode(String ssrvSrvCode) {
