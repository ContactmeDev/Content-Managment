...
//List of LanguageMast & Select
    private List<LanguageListRecord> selectionItems = new ArrayList<LanguageListRecord>();
     ...
     public void selectionListener(AjaxBehaviorEvent event) {
        ...
        for (Object selectionKey : selection) {
            ...
            if (dataTable.isRowAvailable()) {
                selectionItems.add((LanguageListRecord) dataTable.getRowData());
            }
        }
        dataTable.setRowKey(originalKey);
    }
     
      public LanguageListRecord getSelectionItem() {
    ...
    public List<LanguageListRecord> getSelectionItems() {
        return selectionItems;
    }

    public void setSelectionItems(List<LanguageListRecord> selectionItems) {
